                ...
                <div class="col-12">
                    <div class="navbar-top">
                        ...
                        <a href="index.html" class="web-logo nav-logo">
                            <img src="{{asset('assets2/images/logo/1.png')}}" class="img-fluid blur-up lazyload" alt="">
                        </a>
                                                            ...
                                                            <div class="dropdown-column m-0">
                                                                <div class="menu-img-banner">
                                                                    <a class="text-title" href="product-circle.html">
                                                                        <img src="{{asset('assets2/images/mega-menu.png')}}"
                                                                            alt="banner">
                                                                    </a>
                                                                </div>
                                                            </div>
                            ...
                            <ul class="category-list">
                                <li class="onhover-category-list">
                                    <a href="javascript:void(0)" class="category-name">
                                        <img src="{{asset('assets2/svg/1/vegetable.svg')}}" alt="">
                                ...
                                <li class="onhover-category-list">
                                    <a href="javascript:void(0)" class="category-name">
                                        <img src="{{asset('assets2/svg/1/cup.svg')}}" alt="">
                                        <h6>Beverages</h6>
                                        <i class="fa-solid fa-angle-right"></i>
                                    </a>
                                ...
                                <li class="onhover-category-list">
                                    <a href="javascript:void(0)" class="category-name">
                                        <img src="{{asset('assets2/svg/1/meats.svg')}}" alt="">
                                        <h6>Meats & Seafood</h6>
                                        <i class="fa-solid fa-angle-right"></i>
                                    </a>
                                ...
                                <li class="onhover-category-list">
                                    <a href="javascript:void(0)" class="category-name">
                                        <img src="{{asset('assets2/svg/1/breakfast.svg')}}" alt="">
                                ...
                                <li class="onhover-category-list">
                                    <a href="javascript:void(0)" class="category-name">
                                        <img src="{{asset('assets2/svg/1/frozen.svg')}}" alt="">
                                        <h6>Frozen Foods</h6>
                                        <i class="fa-solid fa-angle-right"></i>
                                    </a>
                                ...
                                <li class="onhover-category-list">
                                    <a href="javascript:void(0)" class="category-name">
                                        <img src="{{asset('assets2/svg/1/biscuit.svg')}}" alt="">
                                ...
                                <li class="onhover-category-list">
                                    <a href="javascript:void(0)" class="category-name">
                                        <img src="{{asset('assets2/svg/1/grocery.svg')}}" alt="">
